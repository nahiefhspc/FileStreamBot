...
class Telegram:
    ...
    FILE_PIC = env.get('FILE_PIC', "https://i.ibb.co/9Hd6zjPw/x.jpg")
    START_PIC = env.get('START_PIC', "https://i.ibb.co/9Hd6zjPw/x.jpg")
    VERIFY_PIC = env.get('VERIFY_PIC', "https://i.ibb.co/9Hd6zjPw/x.jpg")
    MULTI_CLIENT = False
